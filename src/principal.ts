...
let donante1: Cl_Donante = new Cl_Donante("Sofía", 10, 80);
let donante2: Cl_Donante = new Cl_Donante("Mateo", 0, 600);
let donante3: Cl_Donante = new Cl_Donante("Elena", 50, 0);
let donante4: Cl_Donante = new Cl_Donante("David", 20, 100);
